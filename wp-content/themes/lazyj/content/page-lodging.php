  ...
  <div class="container">
    ...
    <!-- left column -->
      <div class="col-sm-8 col-md-8">
        ...
        <!-- left column panels -->
        <div class="panel">
          <div class="col-xs-12 col-sm-12 col-md-12 panel-box">
            <div class="col-xs-4 col-sm-4 col-md-3">
              <div class="panel-img">
                <img src="<?php bloginfo('template_directory' ); ?>/img/lodging_img_1.png" alt="">
              </div>
            </div>
            <div class="col-sm-8 col-md-9 panel-content">
              <h3>
                NON DIGNISSIM PORTA
              </h3>
              <p>
              ...
              <div class="panel-box button btn">
                <a href="">
                  Learn More
                </a>
              </div>
        ...
        <div class="panel">
          <div class="col-xs-12 col-sm-12 col-md-12 panel-box">
            <div class="col-xs-4 col-sm-4 col-md-3">
              <div class="panel-img">
                <img src="<?php bloginfo('template_directory' ); ?>/img/lodging_img_2.png" alt="">
              </div>
            </div>
            <div class="col-sm-8 col-md-9 panel-content">
              <h3>
        ...
        <div class="panel">
          <div class="col-xs-12 col-sm-12 col-md-12 panel-box">
            <div class="col-xs-4 col-sm-4 col-md-3">
              <div class="panel-img">
                <img src="<?php bloginfo('template_directory' ); ?>/img/lodging_img_3.png" alt="">
              </div>
            </div>
            <div class="col-sm-8 col-md-9 panel-content">
              <h3>
